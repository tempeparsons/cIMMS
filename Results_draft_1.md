...
, plotting the propsed means and standard deviations on to this data and finally by plotting a reconstruction of the data shown as a contour map, including means and sdt(se?) of mean.  
